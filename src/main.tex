...
\definecolor{darkblue}{HTML}{002CAE}
\definecolor{lightblue}{HTML}{e8ebff}
\definecolor{darkpurple}{HTML}{A74ABE}
\definecolor{lightpurple}{HTML}{ece7fe}
\definecolor{orange}{HTML}{DB7900}
\definecolor{lightorange}{HTML}{fff5e6}
